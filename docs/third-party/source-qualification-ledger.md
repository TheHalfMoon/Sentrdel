...
modifications: no upstream source modified/copied; Sentrdel adds a private containment wrapper, lifecycle regressions, and the PWQ-001-D1 macOS post-reap absence proof/live-group canary.
qualified_by: Sentrdel dependency qualification review
