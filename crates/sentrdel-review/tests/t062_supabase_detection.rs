...
use sentrdel_review::supabase_detection::{detect_supabase, SupabaseStaticPostureStatus};
use sentrdel_schema::coverage::CoverageState;

const POSITIVE_CONFIG: &str = include_str!(
    "../../../fixtures/repos/t062-supabase/positive/supabase/config.toml"
);
const NEGATIVE_CONFIG: &str = include_str!(
    "../../../fixtures/repos/t062-supabase/negative/docs/supabase/config.toml"
);
...
fn positive_and_negative_fixture_layouts_preserve_detection_only_semantics() {
    ...
    let posture = positive.static_posture.expect("detected provider posture marker");
