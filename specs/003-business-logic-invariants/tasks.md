...
- [ ] **R3-T020** Add cross-layer correlation tests proving safe and unsafe paths remain distinguishishable, ambiguous links do not satisfy invariants, graph confidence cannot upgrade epistemic authority, R2 static posture cannot become hosted truth and path-cap exhaustion fails visible.
