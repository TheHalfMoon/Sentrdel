...
- [x] R2-T026 Extend `sentrdel explain` provider context so R2 Findings show static provenance, affected Supabase object/control layer, and explicit non-live limitation.
- [x] R2-T027 Add E2E fixture repositories proving review/init/explain deterministic behavior across safe, vulnerable, contradictory/unknown, unsupported syntax, and hostile repository cases.
