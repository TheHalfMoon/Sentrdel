...
- [x] T019 Implement redaction-before-persist boundary and tests proving discovered secret plaintext **and stable unkeyed value-only secret hashes** never appear in SQLite/export/log/snapshot fixtures.
